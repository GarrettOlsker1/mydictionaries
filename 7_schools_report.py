...
# How many shcools are in this file
print(len(schools))
...
for price in schools:
    if price["NCAA"]["NAIA conference number football (IC2020)"] in conference_schools:
        if (price["Total price for in-state students living on campus (not with family) 2020-21 (DRVIC2020)"]> 50000):
